...
<div class="container">
<div class="row">
<form id="agreeFrm" name="frm" method="get" action="./create"> 
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
	...
	<div class="slider_btn" style="margin-bottom: 30px; text-align: center;">
		<a href="#" class="btn-primary" onclick="javascript:send();">동의</a> 
